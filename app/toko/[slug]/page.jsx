  ...
  return (
    <div className="container mx-auto mt-8 px-4">
      <div className="flex flex-col items-center">
        <img src={tokoData.img} alt={tokoData.name} className="mb-4 w-40 h-40 md:w-64 md:h-64 border border-black object-cover rounded-[50%]" />
      ...
      <h2 className="text-xl font-semibold mb-4 border-b-2">Makanan & Minuman</h2>
